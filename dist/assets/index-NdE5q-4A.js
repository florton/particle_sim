...
precision highp float;
out vec4 o;
void main() { o = vec4(0.0); }`,Io=`#version 300 es
precision highp float;
in vec2 aPos;
in vec2 aVel;
in vec2 aCorner;
